    ...
    <form @submit.prevent="register()" class="d-flex flex-column p-3 my-5 mx-3">
      ...
      <div class="row row-cols-2 mb-3">
        <div class="col-md-6 col-12 form-outline">
          ...
          <input
            ...
            required
          />
          <p class="m-0 text-danger" v-if="registerFormData && registerFormData.last_name">
            {{ registerFormData.last_name[0] }}
          </p>
        </div>
        <div class="col-md-6 col-12 form-outline">
      ...
      <div class="form-outline mb-3">
        ...
        <input
          ...
          required
        />
        <p class="m-0 text-danger" v-if="registerFormData && registerFormData.email">
          {{ registerFormData.email[0] }}
        </p>
      </div>
      <!-- Password input -->
      <div class="row">
        <div class="col col-md-6 col-12 form-outline mb-4">
          ...
          />
          <p class="m-0 text-danger" v-if="registerFormData && registerFormData.password">
            {{ registerFormData.password[0] }}
          </p>
        </div>
        <div class="col col-md-6 col-12 form-outline mb-4">
